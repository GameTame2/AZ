    ...
    <section className="about-us">
      ...
      <div className="about-us-container">
        ...
        <div className="about-us-arda">
          <img
            className="arda-bg"
            src="/images/hero-image-arda.png"
            alt="arda"
          />
          <h1>АРДА ХАЛИБРЯМ</h1>
        ...
        <div className="about-us-simeon">
          <img
            className="simeon-bg"
            src="/images/hero-image-simeon.png"
            alt="simeon"
          />
          <h1>СИМЕОН ХРИСТОВ</h1>
          <img
            className="simeon-img"
      ...
      <div className="footer-about">
        <p>
          Автори: Арда Халибрям и Симеон Христов - ученици в 9 клас на Средно
          училище "Отец Паисий", гр. Кърджали
        </p>
      </div>
    </section>
  );
