    ...
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit} className="quiz-grid">
        <div id="quiz-box-3" className="quiz-box">
          <p>Какъв е цветът на косата ви?</p>
          <label>
            <input
              type="radio"
              name="question3"
        ...
        <div id="quiz-box-14" className="quiz-box">
          <p>Право или скосено слепоочие?</p>
          <label>
            <input
              type="radio"
              name="question14"
        ...
        <div id="quiz-box-20" className="quiz-box">
          <p>Червендалесто или млечно лице?</p>
          <label>
            <input
              type="radio"
              name="question20"
        ...
        <div id="quiz-box-34" className="quiz-box">
          <p>Тъп или прав ъгъл на челюстта?</p>
          <label>
            <input
              type="radio"
              name="question34"
        ...
        <div id="quiz-box-36" className="quiz-box">
          <p>Изпъкнало или гладко надвеждие?</p>
          <label>
            <input
              type="radio"
              name="question36"
        ...
        <div id="quiz-box-38" className="quiz-box">
          <p>Прави или дъгообразни вежди?</p>
          <label>
            <input
              type="radio"
              name="question38"
