    ...
    <div className="job ped">
      <div className="jobmodel">
        ...
        <div className="artp">
          ...
          Имаш невероятен талант за педагогика! Обичаш да обучаваш и вдъхновяваш
          хората, да споделяш знания и да помагаш на другите да растат и се
          развиват. Твоето търпение и умение да разбирате нуждите на учениците
