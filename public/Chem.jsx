  ...
  return (
    <group ref={groupRef} {...props} dispose={null}>
      ...
      <mesh
        ...
        position={[2.758, 1.281, 1.1]}
      />
      <mesh
        geometry={nodes.Object_6.geometry}
        material={materials.vidrio}
        position={[0.806, 1.281, 1.1]}
      />
      <mesh
        geometry={nodes.Object_8.geometry}
        material={materials.vidrio}
        position={[0.5, 1.314, -0.7]}
      />
      <mesh
        geometry={nodes.Object_10.geometry}
        material={materials.vidrio}
        position={[2, 1.314, -0.7]}
      />
      <mesh
        geometry={nodes.Object_12.geometry}
        material={materials.vidrio}
        position={[1.5, 1.314, -0.7]}
      />
      <mesh
        geometry={nodes.Object_14.geometry}
        material={materials.vidrio}
        position={[1, 1.314, -0.7]}
      />
      <mesh
        geometry={nodes.Object_16.geometry}
        material={materials.vidrio}
        position={[-0.902, 1.281, 1.1]}
      />
      <mesh
        geometry={nodes.Object_18.geometry}
        material={materials.vidrio}
        position={[-2.396, 1.799, 1.1]}
      />
      <mesh
        geometry={nodes.Object_20.geometry}
        material={materials.vidrio}
        position={[-0.765, 1.876, -0.5]}
      />
      <mesh
        geometry={nodes.Object_22.geometry}
        material={materials.Soporte}
        position={[1.25, 0.069, -0.7]}
      />
    </group>
  );
}
