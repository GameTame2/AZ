...
export default function Coordinate(props) {
  ...
  return (
    <group {...props} dispose={null} ref={groupRef} scale={[2, 2, 2]}> {/* Scale the component to make it bigger */}
      <group rotation={[0, 0.151, 0]}>
        <group position={[-0.017, -1.155, 0.638]}>
          ...
          <mesh geometry={nodes.Object_13.geometry} material={materials.material_7} />
          <mesh geometry={nodes.Object_14.geometry} material={materials.material_8} />
          <mesh geometry={nodes.Object_15.geometry} material={materials.material_9} />
          <mesh geometry={nodes.Object_16.geometry} material={materials.material_10} />
          <mesh geometry={nodes.Object_18.geometry} material={materials.material_11} position={[0.042, 1.287, -0.442]} scale={0.051} />
        </group>
      </group>
    </group>
  );
